...
<html>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function show()
        {
            ...
            if(choice[0].checked)
            {
                ...
                document.getElementById("heading").innerText="Update Medicine";
				...
				obj.open("get","update_medicine.jsp",true);
				obj.send();
            ...
            else if(choice[1].checked)
            {
                ...
                document.getElementById("heading").innerText="Update Doctor";
				...
				obj.open("get","update_doctor.jsp",true);
				obj.send();
  ...
  <body style="background: none">
		...
		<form method="get" action="update_medicine_query.jsp" style="margin-top:20px">
		...
		<form method="get" action="update_doctor_query.jsp" style="margin-top:20px">
			<div id="doctor_view">
				<table border="3" cellspacing="5" cellpadding="8" style="font-size: 20px;margin-top: 10px" align="center" width="85%">
					<col width="19%">
					<col width="18%">
